...
class LeilaoTest extends TestCase
{
    ...
    public function testProporLanceEmLeilaoFinalizadoDeveLancarExcecao()
    {
        ...
        $this->expectExceptionMessage(Leilao::LISTA_MENSAGENS_DE_ERRO['leilao-finalizado']);
    ...
    {
        $this->expectException(DomainException::class);
        $this->expectExceptionMessage(Leilao::LISTA_MENSAGENS_DE_ERRO['usuario-ja-deu-o-ultimo-lance']);
